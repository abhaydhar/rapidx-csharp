    ...
    public class SettingsRepository
    {
        ...
        public static bool InitializeArtValidationDBContext()
        {
            try
            {
                ...
                List<ArtValidationNonHexaDBContext> lstdbNonHexaContext = new List<ArtValidationNonHexaDBContext>();
                ...
                singletonLdap.DBValidationNonHexaContext = lstdbContext[1];
        ...
        public static bool InitializeLExcemptedOus()
        {
            try
            {
                List<ExcemptedOUs> lstExcemptedOUs = new List<ExcemptedOUs>();

                SingletonExcemptedOUs singletonLdap = SingletonExcemptedOUs.Instance;
                DAL_Settings objDALSetting = new DAL_Settings();
                lstExcemptedOUs = objDALSetting.GetExcemptedOUs();

                singletonLdap.ExcemptedOUs = lstExcemptedOUs;
