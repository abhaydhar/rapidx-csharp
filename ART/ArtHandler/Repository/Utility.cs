...
namespace ArtHandler.Repository
{
    public static class Utility
    {
        ...
        public static bool IsInternetRequest()
        {
            //int loop1, loop2;
            ...
            if (arr1.Contains("X-ARR-LOG-ID") || arr1.Contains("HTTP_X_ARR_LOG_ID"))
            {
                return true;
            }
            else
        ...
        public static bool CheckSpecialCharacter(string answer)
        {
            char[] theCharacetrers = new [] {'&','<','>'};
            if (answer.IndexOfAny(theCharacetrers) != -1)
            {
                return true;
            }
            else
