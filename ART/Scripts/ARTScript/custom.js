...
var custom = {
    ...
    fnFormatDate: function (datetime) {
        ...
        var eventDate = (date.getMonth() + 1 + "/" + date.getDate() + "/" + date.getFullYear() + " " + strTime);
        return eventDate;
...
$(document).ready(function () {
    ...
    // all user id limit alphanumeric
    $('.clsaplhaenrollkey').keypress(function (e) {
    ...
    $('input#CaptchaCode, input[type=password]').focusin(function () {
...
function fnValidateUserAnswer(answer) {
    var re = /[&<>]/gi;
