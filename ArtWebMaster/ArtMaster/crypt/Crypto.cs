...
namespace ArtMaster.crypt
{
    public static class Crypto
    {
        public static string DecryptStringAES(string BaseString)
        {
            try
            {
                var keybytes = Encoding.UTF8.GetBytes("7061737323313233");
                var iv = Encoding.UTF8.GetBytes("7061737323313233");
                //var keybytes = Encoding.UTF8.GetBytes("hexaware");
                //var iv = Encoding.UTF8.GetBytes("hexaware");
                ...
                var encrypted = Convert.FromBase64String(BaseString);
